...
class JCacheStorage
{
	...
	public static function getInstance($handler = null, $options = array())
	{
		...
		if (!isset($handler))
		{
			...
			if (empty($handler))
			{
				return JLog::add(JText::_('JLIB_CACHE_ERROR_CACHE_HANDLER_NOT_SET'), JLog::WARNING, 'jerror');
			}
		}
		...
		if (!class_exists($class))
		{
			...
			{
				return JLog::add(JText::sprintf('JLIB_CACHE_ERROR_CACHE_STORAGE_LOAD', $handler), JLog::WARNING, 'jerror');
			}
		}
