...
/**
 * OAuth Token Credentials class for the Joomla Platform
 *
 * @package     Joomla.Platform
 * @subpackage  OAuth1
 * @since       12.3
 */
class JOAuth1CredentialsStateToken extends JOAuth1CredentialsState
{
	/**
	...
	public function revoke()
	{
		...
		return new JOAuth1CredentialsStateRevoked($this->table);
	}
}
