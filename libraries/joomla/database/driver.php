...
/**
 * Database driver connector class.
 *
 * @package     Joomla.Platform
 * @subpackage  Database
 * @since       11.1
...
abstract class JDatabaseDriver implements JDatabaseInterface
{
	...
	public static function getConnectors()
	{
		...
		// Get a list of types.
		$types = JFolder::files(dirname(__FILE__) . '/driver');
		...
		foreach ($types as $type)
		{
			...
			if (!class_exists($class))
			{
				...
				$path = dirname(__FILE__) . '/driver/' . $type;
	...
	{
		// Deprecation warning.
		JLog::add('JDatabaseDriver::addQuoted() is deprecated.', JLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		JLog::add('JDatabaseDriver::debug() is deprecated, use JDatabaseDriver::setDebug() instead.', JLog::NOTICE, 'deprecated');
	...
	{
		// Deprecation warning.
		JLog::add('JDatabaseDriver::getEscaped() is deprecated. Use JDatabaseDriver::escape().', JLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		JLog::add('JDatabaseDriver::getTableFields() is deprecated. Use JDatabaseDriver::getTableColumns().', JLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		JLog::add('JDatabaseDriver::getTicker() is deprecated, use JDatabaseDriver::getCount() instead.', JLog::NOTICE, 'deprecated');
	...
	{
		JLog::add('JDatabaseDriver::hasUTF() is deprecated.', JLog::WARNING, 'deprecated');
		return true;
	}
	...
	{
		// Deprecation warning.
		JLog::add('JDatabaseDriver::isQuoted() is deprecated.', JLog::WARNING, 'deprecated');
	...
	public function loadResultArray($offset = 0)
	{
		...
		// Deprecation warning.
		JLog::add('JDatabaseDriver::loadResultArray() is deprecated. Use JDatabaseDriver::loadColumn().', JLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		JLog::add('JDatabaseDriver::nameQuote() is deprecated. Use JDatabaseDriver::quoteName().', JLog::WARNING, 'deprecated');
	...
	public function query()
	{
		...
		// Deprecation warning.
		JLog::add('JDatabaseDriver::query() is deprecated. Use JDatabaseDriver::execute() instead.', JLog::WARNING, 'deprecated');
