...
class JDomHtmlGridAccesslevel extends JDomHtmlGrid
{
	...
	function build()
	{
		...
		if (version_compare(JVERSION, '1.6', '<'))
		{
			...
			$html = '<a href="javascript:void(0);"<%STYLE%><%CLASS%><%SELECTORS%>'
				.	' onclick="return listItemTask(\'cb'. (int)$this->num .'\',\''. $task_access .'\')" '
				. 	$color_access .'>'
				. 	JText::_( $this->viewLevelName() )
				.	'</a>';
