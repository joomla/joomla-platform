...
ALTER TABLE `jos_users` CHANGE `id` `id` INT(10)  UNSIGNED  NOT NULL  AUTO_INCREMENT;
...
CREATE TABLE IF NOT EXISTS `jos_content_inspector` (
  `content_id` int(11) unsigned NOT NULL,
  `test` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`content_id`),
  CONSTRAINT `jos_content_inspector_ibfk_1` FOREIGN KEY (`content_id`) REFERENCES `jos_content` (`content_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `jos_ucmcontent_types` (
  `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) NOT NULL DEFAULT '',
  `table` varchar(255) NOT NULL DEFAULT '',
