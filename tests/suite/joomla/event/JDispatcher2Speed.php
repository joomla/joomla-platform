...
class JDispatcherSpeed extends PHPUnit_Framework_TestCase
{
	...
	public function testJoomlaDispatcher()
	{
		...
		// New dispatcher
		$this->timer_start();
		$dispatcher2 = JDispatcher2::getInstance();
		$dispatcher2->addDiscoverableEvents( array( 'onSomeTrigger' ) );
		JPluginHelper::importPlugin( 'joomla', null, true, $dispatcher2 );
		print "New dispatcher: starting...\n";
		$counter = 0;
		$this->triggerEvent2( 'onSomeTrigger', array( &$counter ) );
		print "New dispatcher: done.\n\tRan " . $counter
