...
/* Standard: @TODO: Concatenation: Concat operator must be surrounded by spaces.
(Joomla.WhiteSpace...)
*/
$i . 'test';
...
(int) $i;
(int) $i;
/* Standard: Space found before semicolon;
...
/* Standard: Functions and classes must not contain multiple empty lines in a row.
 (Joomla.WhiteSpace.SuperfluousWhitespace){HL:9}
*/
/**
 * Comment
 *
...
/* Standard: Please end your files with an empty line.
 (Joomla.WhiteSpace.SuperfluousWhitespace){HL:1}
*/
/* ENDDOC */
$foo;
