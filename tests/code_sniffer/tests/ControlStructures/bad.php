...
/* Standard: if-else: Wrong brace placement
 (Joomla.ControlStructures.ControlSignature){HL:1,3,5}
*/
if ($test) {
	echo 'True';
} elseif ($test === false) {
...
/* Standard: do-while: Wrong brace placement / wrong spacing
 (Joomla.ControlStructures.ControlSignature){HL:1,3}
*/
do {
	$i++;
} while ($i < 10);
...
/* Standard: Inline control structures are discouraged
 (Joomla.ControlStructures.InlineControlStructure.Discouraged)
*/
if(true) true;
